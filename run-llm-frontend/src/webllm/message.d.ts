import { AppConfig, ChatOptions, GenerationConfig } from "../src/config";
import { InitProgressReport } from "../src/types";
import { ChatCompletionRequestStreaming, ChatCompletionRequestNonStreaming, ChatCompletion, ChatCompletionChunk } from "../src/openai_api_protocols/index";
/**
 * Message kind used by worker
 */
type RequestKind = "reload" | "generate" | "runtimeStatsText" | "interruptGenerate" | "unload" | "resetChat" | "init" | "getMaxStorageBufferBindingSize" | "getGPUVendor" | "forwardTokensAndSample" | "chatCompletionNonStreaming" | "getMessage" | "chatCompletionStreamInit" | "chatCompletionStreamNextChunk" | "customRequest" | "keepAlive" | "heartbeat";
...
export type WorkerResponse = OneTimeWorkerResponse | InitProgressWorkerResponse | GenerateProgressWorkerResponse;
export {};
