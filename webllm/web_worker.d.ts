import { AppConfig, ChatOptions, MLCEngineConfig, GenerationConfig } from "../src/config";
import { MLCEngineInterface, GenerateProgressCallback, InitProgressCallback, InitProgressReport } from "../src/types";
import { ChatCompletionRequestBase, ChatCompletionRequestStreaming, ChatCompletionRequestNonStreaming, ChatCompletion, ChatCompletionChunk } from "../src/openai_api_protocols/index";
import * as API from "../src/openai_api_protocols/apis";
import { MessageContent, WorkerRequest } from "../src/message";
 ...
 */
export declare class MLCEngineWorkerHandler {
     ...
     *   DOM API directly.
     */
    constructor(engine: MLCEngineInterface, postMessageHandler?: PostMessageHandler, initProgressCallback?: (report: InitProgressReport) => void);
 ...
 */
export declare function CreateWebWorkerMLCEngine(worker: any, modelId: string, engineConfig?: MLCEngineConfig): Promise<WebWorkerMLCEngine>;
/**
